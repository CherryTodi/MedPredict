...
![Maternal](graphics/pregnancy_prediction.png)



## Fetal Health Prediction

![Fetal](graphics/fetal_prediction.png)



## Analytics Dashboard

![Dashboard1](graphics/dashboard1.png)

![Dashboard2](graphics/dashboard2.png)
...
```bash py -m streamlit run app.py
